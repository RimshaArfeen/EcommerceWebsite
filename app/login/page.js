          ...
          < div className="p-8 sm:p-12 space-y-8" >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center p-3 font-semibold rounded-xl text-sm transition-all duration-200 border border-gray-300 shadow-sm bg-white text-gray-700 hover:bg-gray-200 hover:cursor-pointer"
              >
